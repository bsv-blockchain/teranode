...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		Policy: &PolicySettings{
			...
			MinMiningTxFeeByScriptSize: parseFeeTiers("minminingtxfeebyscriptsize", getMultiString("minminingtxfeebyscriptsize", "|", nil, alternativeContext...)),
			MinMiningTxFeeByScriptOps:  parseFeeTiers("minminingtxfeebyscriptops", getMultiString("minminingtxfeebyscriptops", "|", nil, alternativeContext...)),
