...
// Report invalid subtree reception
type ReportInvalidSubtreeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PeerId        string                 `protobuf:"bytes,1,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"` // Peer ID that provided the subtree
	SubtreeHash   string                 `protobuf:"bytes,2,opt,name=subtree_hash,json=subtreeHash,proto3" json:"subtree_hash,omitempty"`
	Reason        string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"` // Reason why the subtree is considered invalid
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ReportInvalidSubtreeRequest) Reset() {
	*x = ReportInvalidSubtreeRequest{}
	mi := &file_services_p2p_p2p_api_p2p_api_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReportInvalidSubtreeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportInvalidSubtreeRequest) ProtoMessage() {}

func (x *ReportInvalidSubtreeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_services_p2p_p2p_api_p2p_api_proto_msgTypes[35]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportInvalidSubtreeRequest.ProtoReflect.Descriptor instead.
func (*ReportInvalidSubtreeRequest) Descriptor() ([]byte, []int) {
	return file_services_p2p_p2p_api_p2p_api_proto_rawDescGZIP(), []int{35}
}

func (x *ReportInvalidSubtreeRequest) GetPeerId() string {
	if x != nil {
		return x.PeerId
	}
	return ""
...
func (x *ReportInvalidSubtreeRequest) GetSubtreeHash() string {
	if x != nil {
		return x.SubtreeHash
	}
	return ""
...
func (x *ReportInvalidSubtreeRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
type ReportInvalidSubtreeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ReportInvalidSubtreeResponse) Reset() {
	*x = ReportInvalidSubtreeResponse{}
	mi := &file_services_p2p_p2p_api_p2p_api_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ReportInvalidSubtreeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportInvalidSubtreeResponse) ProtoMessage() {}

func (x *ReportInvalidSubtreeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_services_p2p_p2p_api_p2p_api_proto_msgTypes[36]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportInvalidSubtreeResponse.ProtoReflect.Descriptor instead.
func (*ReportInvalidSubtreeResponse) Descriptor() ([]byte, []int) {
	return file_services_p2p_p2p_api_p2p_api_proto_rawDescGZIP(), []int{36}
}

func (x *ReportInvalidSubtreeResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *ReportInvalidSubtreeResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_services_p2p_p2p_api_p2p_api_proto_goTypes = []any{
	...
	(*ReportInvalidSubtreeRequest)(nil),     // 35: p2p_api.ReportInvalidSubtreeRequest
	(*ReportInvalidSubtreeResponse)(nil),    // 36: p2p_api.ReportInvalidSubtreeResponse
	(*ReportValidBlockRequest)(nil),         // 37: p2p_api.ReportValidBlockRequest
	(*ReportValidBlockResponse)(nil),        // 38: p2p_api.ReportValidBlockResponse
...
var file_services_p2p_p2p_api_p2p_api_proto_depIdxs = []int32{
	...
	35, // 22: p2p_api.PeerService.reportInvalidSubtree:input_type -> p2p_api.ReportInvalidSubtreeRequest
	37, // 23: p2p_api.PeerService.ReportValidBlock:input_type -> p2p_api.ReportValidBlockRequest
	...
	36, // 47: p2p_api.PeerService.reportInvalidSubtree:output_type -> p2p_api.ReportInvalidSubtreeResponse
	38, // 48: p2p_api.PeerService.ReportValidBlock:output_type -> p2p_api.ReportValidBlockResponse
