...
const (
	...
	PeerService_ReportInvalidSubtree_FullMethodName    = "/p2p_api.PeerService/reportInvalidSubtree"
...
type PeerServiceClient interface {
	...
	ReportInvalidSubtree(ctx context.Context, in *ReportInvalidSubtreeRequest, opts ...grpc.CallOption) (*ReportInvalidSubtreeResponse, error)
...
func (c *peerServiceClient) ReportInvalidSubtree(ctx context.Context, in *ReportInvalidSubtreeRequest, opts ...grpc.CallOption) (*ReportInvalidSubtreeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportInvalidSubtreeResponse)
	err := c.cc.Invoke(ctx, PeerService_ReportInvalidSubtree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PeerServiceServer interface {
	...
	ReportInvalidSubtree(context.Context, *ReportInvalidSubtreeRequest) (*ReportInvalidSubtreeResponse, error)
...
func (UnimplementedPeerServiceServer) ReportInvalidSubtree(context.Context, *ReportInvalidSubtreeRequest) (*ReportInvalidSubtreeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method reportInvalidSubtree not implemented")
}
...
func _PeerService_ReportInvalidSubtree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportInvalidSubtreeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PeerServiceServer).ReportInvalidSubtree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PeerService_ReportInvalidSubtree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerServiceServer).ReportInvalidSubtree(ctx, req.(*ReportInvalidSubtreeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PeerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "reportInvalidSubtree",
			Handler:    _PeerService_ReportInvalidSubtree_Handler,
		},
		{
