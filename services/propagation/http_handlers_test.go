...
func TestHandleSingleTx(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedResponse:   "500 internal error",
		},
		{
			name:                "Transaction validation error",
			requestBody:         txBytes,
			expectedStatusCode:  http.StatusBadRequest,
			expectedResponse:    "400 transaction invalid",
		...
		},
		{
			...
			requestBody:         txBytes,
			expectedStatusCode:  http.StatusBadRequest,
			expectedResponse:    "400 transaction policy rejection",
		...
		},
		{
			...
			expectedResponse:    "409 double spend",
		...
		},
		{
			...
			requestBody:         txBytes,
			expectedStatusCode:  http.StatusConflict,
			expectedResponse:    "409 transaction conflicting",
		...
		},
		{
			...
			expectedResponse:    "403 utxo frozen",
		...
		},
		{
			...
			expectedResponse:    "422 transaction missing parent",
