...
func TestHandleSingleTx(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedResponse:    "TX_INVALID_DOUBLE_SPEND (32)",
		...
		},
		{
			...
			requestBody:         txBytes,
			expectedStatusCode:  http.StatusConflict,
			expectedResponse:    "TX_CONFLICTING (36)",
		...
		},
		{
			...
			expectedResponse:    "UTXO_FROZEN (72)",
		...
		},
		{
			...
			expectedResponse:    "TX_MISSING_PARENT (34)",
