...
transition ranges that embed an IPv4 address. With `true` that check is skipped entirely, so
an announced URL naming any such address is accepted into the peer registry.
